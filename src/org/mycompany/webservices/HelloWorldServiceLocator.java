...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.mycompany.webservices.HelloWorldService {
    ...
    public org.mycompany.webservices.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public org.mycompany.webservices.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.mycompany.webservices.HelloWorldSoapBindingStub _stub = new org.mycompany.webservices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.mycompany.webservices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.mycompany.webservices.HelloWorldSoapBindingStub _stub = new org.mycompany.webservices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.mycompany.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.mycompany.org", "HelloWorld"));
        }
